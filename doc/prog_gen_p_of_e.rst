...
To run the ``SHE_GST_GenPOfE`` program with Elements, use the following command in an EDEN 2.1 environment:

.. code:: bash

    E-Run SHE_GST 8.2 SHE_GST_GenPOfE --workdir <dir> [--log-file <filename>] [--log-level <value>] [--pipeline_config <filename>]
...
.. code:: bash
    ...
    E-Run SHE_GST 8.2 SHE_GST_GenPOfE --workdir $WORKDIR [--log-file <filename>] [--log-level <value>] [--pipeline_config <filename>]
