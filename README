...
* Rob Blake (rpb@roe.ac.uk)   ---Not sure if I qualify for this. Should someone else be here?

### Other Contributors


## Purpose
This project contains functionality to generate galaxy image simulations. This is separate from OU-SIM's simulations, as it contains less functionality in order to expedite the process (e.g., it doesn't simulate cosmic rays, and so also skips the step of detecting them).
